"""Team data structures for personality customization."""
...
class BotTeamProfile:
    """How a bot appears within a team."""
    ...
    bot_name: str = ""  # Character name within team (e.g., "Blackbeard", "Slash")
...
@dataclass
class Team:
    """Complete personality team configuration."""

    name: TeamName  # Team identifier
    description: str  # Team description
    leader: BotTeamProfile  # leader theming
    researcher: BotTeamProfile  # @researcher theming
    coder: BotTeamProfile  # @coder theming
    social: BotTeamProfile  # @social theming
    creative: BotTeamProfile  # @creative theming
    auditor: BotTeamProfile  # @auditor theming
    affinity_modifiers: Dict[str, float] = field(default_factory=dict)
    """Modifiers to affinity relationships in this team"""

    metadata: Dict[str, Any] = field(default_factory=dict)
    """Additional team metadata"""

    def get_bot_theming(self, bot_role: str) -> Optional[BotTeamProfile]:
        ...
        Returns:
            BotTeamProfile or None if bot not found
        """
        bot_map = {
            "leader": self.leader,
    ...
    def get_all_bots_theming(self) -> Dict[str, BotTeamProfile]:
